...
> **Boundary:** For objection responses, use `objection-pre-handler`: that skill already covers objection acknowledgment/response/follow-up in depth. This skill is for the other asset types: one-pagers, ROI calculators, proposals, and playbooks.
