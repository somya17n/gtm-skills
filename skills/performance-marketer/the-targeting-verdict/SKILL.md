...
7. **Where the verdict is broad, say so plainly** and hand the real work to `the-angle-spread`. The
...
- If the verdict is broad, is the handoff to `the-angle-spread` stated?
